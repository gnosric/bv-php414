          ...
          <div class="collapse navbar-collapse" id="header-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right" id="top-nav">
              ...
              <ul class="dropdown-menu" id="products-dropdown">
                  <li>
                    <a href="products/director.php"><img class="img-responsive" src="img/menu-thumbs/product-director-thumb.png" alt="Director" />director</a>
                    <p class="sentenceCase">Boards of Directors</p>
                  </li>
                  <li>
                    <a href="products/meetx.php"><img class="img-responsive" src="img/menu-thumbs/product-meetx-thumb.png" alt="MeetX" />meetx</a>
                    <p class="sentenceCase">Senior Leadership</p>
                  </li>
                  <li>
                    <a href="products/sharex.php"><img class="img-responsive" src="img/menu-thumbs/product-sharex-thumb.png" alt="ShareX" />sharex</a>
